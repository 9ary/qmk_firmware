 ...
 * Space Cadet Shift
 */
#define LCPO_KEYS KC_LCTL, KC_LEFT_SHIFT, KC_LEFT_BRACKET
#define RCPC_KEYS KC_RCTL, KC_RIGHT_SHIFT, KC_RIGHT_BRACKET
#define LAPO_KEYS KC_LGUI, KC_TRANSPARENT, KC_LEFT_BRACKET
#define RAPC_KEYS KC_LGUI, KC_TRANSPARENT, KC_RIGHT_BRACKET
